...
window.addEventListener("DOMContentLoaded", function () {
  ...
  function maskInit() {
    let enableAccept = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
    enableAcceptIcon = enableAccept;
    if (enableAcceptIcon && !cssInserted) {
      setCssForAccept();
    }
    document.querySelectorAll('input[autocomplete="tel"]').forEach(inputTel => {
      ...
      inputTel.addEventListener('input', function () {
        ...
        if (this.value.length > 18 && this.value.substring(0, 5) == '+7 (8') {
          ...
          this.value = '+7 (' + newval.substring(0, 3) + ') ' + newval.substring(3, 6) + '-' + newval.substring(6, 8) + '-' + newval.substring(8, 12);
          mask.updateValue();
        }
      });
...
class Landing {
  ...
  handResizeBlocks() {
    ...
    if (!(handContainer && handBg && handMask)) {
      return;
    }
    ...
    if (stickyMenuLink) {
      stickyMenuLink.forEach(btn => {
        btn.addEventListener('click', event => {
          this.handlerAddSmoothScroll(btn, event);
        });
      });
    }
...
/* harmony import */ var _index_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.js */ "./src/app/index.js");
...
/* harmony import */ var _imasked_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./imasked.js */ "./src/app/imasked.js");
/* harmony import */ var _imasked_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_imasked_js__WEBPACK_IMPORTED_MODULE_2__);
// core app styles:
